...
const change_country_btn = document.querySelectorAll('.change-country');
const close_list_btn = document.querySelector('.close');
const input = document.getElementById('search-input');
const ltu = document.querySelectorAll('.ltu');
const eng = document.querySelectorAll('.eng');
const ltu_language_btn = document.getElementById('ltu');
const eng_language_btn = document.getElementById('eng');
...
change_country_btn.forEach(btn => {
...
// CHANGE LANGUAGE
ltu_language_btn.addEventListener('click', function() {
    eng.forEach(en => {
...
eng_language_btn.addEventListener('click', function() {
